...
const experiences = [
    {
        ...
        technologies: [
            "/path/to/prolog-icon.png",
            "/path/to/openai-icon.png",
            "/path/to/python-icon.png"
        ],
    ...
    },
    {
        ...
        description: [
            "Worked on embedded systems for defense applications.",
            "Collaborated with cross-functional teams to implement solutions."
        ],
        technologies: [
            "/path/to/c-icon.png",
            "/path/to/linux-icon.png",
            "/path/to/embedded-icon.png"
        ],
        imageSrc: "/path/to/company-logo.png"
    }
];
